   ...
   <>
    ...
    <div className='flex gap-[30px] px-24'>
            ...
            <div className='flex flex-col gap-[20px]'>
              ...
              {product.stock > 0 ? (
                product.stock <= 25 ? (
                  <span className='font-medium text-yellow-700'>Available, almost out of stock</span>
                ) : (
              ...
              {product.stock > 0 ? (
                <div>
                  <Button
                    type="button"
                    className="inline-flex items-center justify-center gap-2 p-4 bg-[#74512D] text-center hover:bg-[#74512D] text-white active:bg-[#74512D]"
                  >
                ...
                <div>
                  <Button
                    type="button"
                    className="inline-flex items-center justify-center gap-2 p-4 bg-[#B7B7B7] text-center"
                  >
                    <FontAwesomeIcon icon={faCartShopping} className="mb-0 text-white" />
